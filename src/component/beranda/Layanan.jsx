...
export default function Layanan() {
    ...
    return (
        <div data-aos="fade-up" className="grid grid-rows-1 grid-cols-4 lg:px-24 md:px-16 cursor-pointer justify-center lg:gap-x-28 md:gap-x-16 gap-x-5 mt-6">
            ...
            <Link to="/pengaduan" className="flex flex-col items-center justify-center">
            ...
            <Link to="/edaran-dan-sanksi" className="flex flex-col items-center justify-center">
            ...
            <Link to="/siaran-pers" className="flex flex-col items-center justify-center">
