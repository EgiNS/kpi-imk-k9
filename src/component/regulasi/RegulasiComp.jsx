        ...
        <div className="mt-6">
            {dataReg[activeTab].map((item) => (
                <div key={item.id} className="flex flex-row gap-x-3">
                    ...
                    <a href={item.link} target='_blank' className="group flex items-center gap-x-3 hover:underline border-b w-full mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width={12} className="icon">
                        <path className="fill-current text-[#420101] group-hover:text-[#420101a2]" d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z"/>
                        </svg>
                        {item.title}
                    </a>
                    : 
                    <div className='border-b w-full mb-2 pb-1'>
                        <div className="flex items-center gap-x-3">
                            ...
                            <a href={item.link} target='_blank' className="hover:underline flex-1">
                            {item.title}
                            </a>
                        </div>
                        <div className="pl-6 text-gray-600 text-sm">{item.ket}</div>
                    </div>
                    }
                </div>          
            ))}
